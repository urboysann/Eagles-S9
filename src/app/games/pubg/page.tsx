...
import { Calendar, MapPin, Users, Trophy, BookOpen, Target, Shield, Clock } from "lucide-react";
...
export default function PubgDetail() {
  ...
  const infoLomba = [
    ...
    { icon: <Users size={22} />, label: "KUOTA", value: "24 TIM", sub: "SQUAD MODE (4+1)" },
  ];
            ...
            >
              <div>
                ...
                <h1 className="text-6xl md:text-8xl font-black italic leading-none uppercase font-outfit">
                  PUBG <br />
                  <span className="text-magenta">MOBILE</span>
                </h1>
              </div>
              ...
              <div className="flex gap-4 py-6 border-y border-white/5">
                ...
                <div className="ml-auto flex items-center gap-2 text-gray-500 italic">
                  <Clock size={16} />
                  <span className="text-[10px] font-bold uppercase tracking-widest">BATAS AKHIR PENDAFTARAN</span>
                </div>
              </div>

              <p className="text-gray-400 text-lg leading-relaxed max-w-xl font-montserrat text-justify">
                Turun, jarah, dan bertahan hidup. <span className="text-white italic">PNB EAGLES Season 9</span> menghadirkan medan tempur paling kompetitif untuk para survivor. Tunjukkan strategi rotasi terbaik dan akurasi tembakan timmu untuk meraih <span className="text-magenta font-bold">Winner Winner Chicken Dinner!</span>
              </p>

              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                  <Target className="text-magenta mb-2" size={24} />
                ...
                <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                  ...
                  <p className="text-lg font-black italic">ERANGEL, MIRAMAR, RONDO</p>
                </div>
              </div>
