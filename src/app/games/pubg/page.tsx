...
export default function PubgDetail() {
  ...
  const GUIDEBOOK_PDF_PATH = "/files/guidebook-pubg.pdf";
  ...
  const infoLomba = [
    { icon: <Calendar size={22} />, label: "TANGGAL TURNAMEN", value: "22 - 23 MEI 2026", sub: "MENYESUAIKAN JADWAL TURNAMEN" },
    { icon: <MapPin size={22} />, label: "LOKASI TURNAMEN", value: "GEDUNG WIDYA PADMA", sub: "KAMPUS POLITEKNIK NEGERI BALI" },
    { icon: <Users size={22} />, label: "KUOTA", value: "24 TIM", sub: "SQUAD MODE (4 + 1 SUB)" },
  ];
    ...
    <>
      ...
      <main className="min-h-screen bg-[#070707] text-white pt-32 pb-20 px-6 relative overflow-hidden font-montserrat">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* Top Navigation with Scrollable Games */}
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-16 gap-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 w-full md:w-auto">
              ...
              <div className="flex overflow-x-auto gap-2 bg-white/5 p-1.5 pb-3 md:pb-1.5 rounded-2xl border border-white/10 backdrop-blur-md w-full md:w-auto custom-scrollbar">
                ...
                {/* Spacer agar item terakhir tidak menempel ke tepi saat di-scroll di mobile */}
            ...
            >
              <div>
                ...
                <h1 className="text-6xl md:text-8xl font-black italic leading-[0.85] uppercase font-outfit tracking-tighter">
                  PUBG <br />
                  <span className="text-magenta drop-shadow-[0_0_20px_rgba(255,80,193,0.4)]">MOBILE</span>
                </h1>
              </div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-xl text-justify font-medium">
                Turun, jarah, dan bertahan hidup. <span className="text-white italic font-bold">PNB EAGLES Season 9</span> menghadirkan medan tempur paling kompetitif. Tunjukkan strategi rotasi terbaik timmu untuk meraih <span className="text-magenta font-bold drop-shadow-[0_0_10px_rgba(255,80,193,0.3)] italic">Winner Winner Chicken Dinner!</span>
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300 flex items-center gap-5">
                  ...
                  <div className="flex flex-col overflow-hidden">
                    ...
                    <p className="text-lg md:text-xl font-black italic uppercase text-white leading-tight">TPP Mode</p>
                  </div>
                </div>
                ...
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300 flex items-center gap-5">
                  ...
                  <div className="flex flex-col overflow-hidden">
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-0.5">Maps</p>
                    <p className="text-lg md:text-xl font-black italic uppercase text-white leading-tight">Erangel, Miramar, Rondo</p>
                  </div>
                </div>
              </div>
