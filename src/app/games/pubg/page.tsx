...
export default function PubgDetail() {
  ...
  // Konfigurasi Link Terpusat (Sesuaikan jika link form atau file berbeda)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-xl text-justify font-medium">
                Turun, jarah, dan bertahan hidup. <span className="text-white italic font-bold">PNB EAGLES Season 9</span> menghadirkan medan tempur paling kompetitif. Tunjukkan strategi rotasi terbaik timmu untuk meraih <span className="text-magenta font-bold">Winner Winner Chicken Dinner!</span>
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300">
                  ...
                  <p className="text-xl font-black italic uppercase text-white">TPP MODE</p>
                </div>
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300">
                  <Shield className="text-magenta mb-3 group-hover:scale-110 transition-transform" size={22} />
                  <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Maps</p>
                  <p className="text-sm font-black italic uppercase text-white">Erangel, Miramar, Rondo</p>
                </div>
              </div>
