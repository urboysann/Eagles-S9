...
import { Calendar, MapPin, Users, Trophy, BookOpen, Zap, Clock } from "lucide-react";
...
export default function TekkenDetail() {
  ...
  const infoLomba = [
    ...
    { icon: <Users size={22} />, label: "KUOTA", value: "32 PLAYER", sub: "1 VS 1 (PLAYSTATION 5)" },
  ];
            ...
            >
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-gray-500 text-[10px] font-bold tracking-widest uppercase">Next-Gen Battle</span>
                </div>
                
                <h1 className="text-5xl md:text-7xl font-black italic leading-none uppercase font-outfit">
                  Turnamen <br />
                  <span className="text-magenta">Tekken 8</span>
                </h1>
              </div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-xl font-montserrat text-justify">
                Bersiaplah untuk pertarungan terdahsyat di <span className="text-white italic">PNB EAGLES Season 9.</span> Tunjukkan teknik combo dan strategi counter terbaikmu di panggung tertinggi. Siapkan diri untuk menghadapi kepalan tangan besi!
              </p>

              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                  <Zap className="text-magenta mb-2" size={24} />
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full max-w-xl">
                <Link href="/register/tekken-8" className="flex-1">
