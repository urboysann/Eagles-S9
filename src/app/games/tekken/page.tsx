  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#070707] text-white pt-32 pb-20 px-6 relative overflow-hidden font-montserrat">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-xl text-justify font-medium">
                Siapkan kombo terbaikmu di <span className="text-white italic font-bold">PNB EAGLES Season 9.</span> Hadapi petarung tangguh lainnya dalam arena Tekken 8 dan buktikan siapa yang layak menjadi 
                <span className="text-magenta font-bold italic ml-1 drop-shadow-[0_0_10px_rgba(255,80,193,0.3)]">KING OF IRON FIST!</span>
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300 flex items-center gap-5">
                  <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center shrink-0">
                    <Swords className="text-magenta group-hover:scale-110 transition-transform" size={24} />
                  </div>
                ...
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300 flex items-center gap-5">
                  <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center shrink-0">
                    <Zap className="text-magenta group-hover:scale-110 transition-transform" size={24} />
                  </div>
                  <div className="flex flex-col overflow-hidden">
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-0.5">Device / Perangkat Turnamen</p>
                    <p className="text-lg md:text-xl font-black italic uppercase text-white leading-tight">PlayStation 5</p>
                  </div>
                </div>
              </div>
            ...
            {/* SISI KANAN: Kartu Info Turnamen */}
            <motion.div 
        ...
        {/* Global Styles untuk Scrollbar & No-Scrollbar */}
        <style jsx global>{`
