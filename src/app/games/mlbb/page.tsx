              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300 flex items-center gap-5">
                  <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center shrink-0">
                    <Sword className="text-magenta group-hover:scale-110 transition-transform" size={24} />
                  </div>
                  <div className="flex flex-col overflow-hidden">
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-0.5">Mode Pertandingan</p>
                    <p className="text-lg md:text-xl font-black italic uppercase text-white leading-tight">Draft Pick</p>
                  </div>
                </div>
                ...
                <div className="p-5 bg-white/5 border border-white/10 rounded-[1.5rem] group hover:border-magenta/40 transition-all duration-300 flex items-center gap-5">
                  ...
                  <div className="flex flex-col overflow-hidden">
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-0.5">Sistem Gugur</p>
                    <p className="text-lg md:text-xl font-black italic uppercase text-white leading-tight">Single Elimination</p>
                  </div>
                </div>
              </div>
