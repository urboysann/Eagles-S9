...
import { Calendar, MapPin, Users, Trophy, BookOpen, Sword, Shield, Clock } from "lucide-react";
...
export default function MlbbDetail() {
  ...
  const infoLomba = [
    ...
    { icon: <Users size={22} />, label: "KUOTA", value: "32 TIM", sub: "5 VS 5" },
  ];
            ...
            >
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-gray-500 text-[10px] font-bold tracking-widest uppercase">REGIONAL Scale</span>
                </div>
                
                <h1 className="text-6xl md:text-8xl font-black italic leading-none uppercase font-outfit">
                  MOBILE <br />
                  <span className="text-magenta">LEGENDS</span>
                </h1>
              </div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-xl font-montserrat text-justify">
                Buktikan ketangguhan timmu di Land of Dawn. <span className="text-white italic">PNB EAGLES Season 9</span> mengundang seluruh squad terbaik untuk memperebutkan gelar juara. Siapkan draft pick terbaik dan hancurkan nexus lawan!
              </p>

              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                  <Sword className="text-magenta mb-2" size={24} />
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-tighter">Mode</p>
                  <p className="text-lg font-black italic uppercase">Draft Pick</p>
                </div>
                <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                  ...
                  <p className="text-lg font-black italic uppercase">Single Elimination</p>
                </div>
              </div>

              {/* ACTION BUTTONS (DIPERBAIKI: Menggunakan flex-1 dan justify-center agar sama panjang) */}
              <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full max-w-xl">
                <Link href="/register/mobile-legends" className="flex-1">
